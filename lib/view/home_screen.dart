...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    _pages = [
      HomeContent(newsViewModel: newsViewModel, name: name),
      const SearchScreen(),
        ...
        child: Padding(
          ...
          child: GNav(
            ...
            tabs: const[
              ...
              GButton(icon: Icons.bookmark_add_outlined, text: 'BookMark'),
...
class HomeContent extends StatefulWidget {
  ...
  const HomeContent({Key? key, required this.newsViewModel, required this.name}) : super(key: key);
        ...
        children: [
          SizedBox(
            ...
            child: FutureBuilder<NewsChannelHeadlinesModel>(
                    future: widget.newsViewModel.fetchNewChannelHeadlinesApi(widget.name),
          ...
          Padding(
            ...
            child: FutureBuilder<categoriesNewsModel>(
                    future: widget.newsViewModel.fetchCategoriesNewsApi('General'),
                    builder: (BuildContext context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        return Center(
                          child: SpinKitSpinningLines(size: 50, color: Colors.blue),
